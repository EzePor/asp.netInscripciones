...
namespace Inscripciones.ApiControllers.MesasExamenes
{
    ...
    [ApiController]
    public class ApiMesaExamenesController : ControllerBase
    {
        private readonly InscripcionesContext _context;

        public ApiMesaExamenesController(InscripcionesContext context)
        {
            _context = context;
        }
